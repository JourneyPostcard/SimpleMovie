...
<style>
    ...
    .banner {
        ...
        color:#0088ff; font-size:20px; line-height:20vh; text-align:center; border-bottom:1px solid #fff; }
    .items { background-color:#355f35; height:80%; }
    .items div {
        font-size:24px;
        padding:10px 30px;
        color:#e2ff00;
    }
    .items i { font-size:20px; }
    .items span {
        margin-left:20px;
        font-family:cursive;
    }
    ...
    .items li:hover { background-color:lightcoral; }
</style>